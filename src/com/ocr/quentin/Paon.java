...
public class Paon extends Oiseaux {
    ...
    public Paon(String prenom, String espece, int age, double taille, double poids, String couleur, String paysOrigine, String alimentation, String sexe, String voler) {
